...
export const DesignInput = (): JSX.Element | null => {
  ...
  return (
    <CreatePageDrawerContentContainer>
      ...
      >
        ...
        >
          <Radio
            ...
            {...register('logo.state')}
          >
            {t('features.headerAndInstruction.logo.default')}
          </Radio>
          <Radio
            allowDeselect={false}
            ...
            {...register('logo.state')}
          >
            {t('features.headerAndInstruction.logo.none')}
          </Radio>
          <Radio
            allowDeselect={false}
            ...
            {...register('logo.state')}
          >
            {t('features.headerAndInstruction.logo.custom')}
          </Radio>
          <FormControl
            id="attachment"
      ...
      >
        <FormLabel>
          {t('features.headerAndInstruction.themeColour.title')}
        </FormLabel>
        <Radio.RadioGroup
      ...
      <FormControl
        ...
        onFocus={setToEditingHeader}
      >
        <FormLabel>{t('features.headerAndInstruction.minutes')}</FormLabel>
        <Controller
          name="estTimeTaken"
          control={control}
          rules={{
      ...
      >
        <FormLabel>{t('features.headerAndInstruction.instruction')}</FormLabel>
        <Textarea
      ...
      <FormFieldDrawerActions
        ...
        buttonText={t('features.headerAndInstruction.cta')}
      />
    </CreatePageDrawerContentContainer>
  )
}
      ...
      <Box pt="1rem" px="1.5rem" bg="white">
        <Flex justify="space-between">
          <Text textStyle="subhead-3" color="secondary.500" mb="1rem">
            {t('features.headerAndInstruction.title')}
          </Text>
